...
int ll_has_cycle(node *head)
{
    ...
    // We’ll call the first one tortoise and the second one hare.
    // Advance hare by two nodes.
    // If this is not possible because of a null pointer, we have found the end of the list, and therefore the list is acyclic.
